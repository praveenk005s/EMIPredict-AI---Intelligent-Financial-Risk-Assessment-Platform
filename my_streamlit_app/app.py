...
CLASSIFIER_PATH = MODEL_DIR / "best_classifier.pkl"
REGRESSOR_PATH = MODEL_DIR / "best_regressor.pkl"

ADMIN_DATA_PATH = DATA_DIR / "admin_applications.csv"

# ==================================================
# LOAD MODELS & ASSETS (LOCAL PKL ONLY)
# ==================================================
@st.cache_resource
def load_models():
...
<p style="color:#9CA3AF">Cloud-Ready EMI Eligibility & Financial Risk Platform</p>
</div>
...
if page == "🏠 Single Prediction":
    ...
    if submit:
        ...
        col1.success("✅ Loan Approved")
        col1.info(f"Risk Category: **{eligibility}**")
...
# ==================================================
    ...
    if valid_admin_df.empty:
        ...
        selected_rows = valid_admin_df[
            valid_admin_df["application_id"].astype(str) == str(selected_id)
        ]

        if selected_rows.empty:
            st.warning("⚠ Selected application not found.")
        else:
...
# ==================================================
    ...
    st.success("✔ Local ML Models (.pkl)")
